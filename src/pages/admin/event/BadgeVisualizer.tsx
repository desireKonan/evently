        ...
        <div className="space-y-4">
          <div>
            ...
            <select 
              ...
              onChange={(e) => setSelectedEvent(SAMPLE_EVENTS.find(ev => ev.id === e.target.value) || SAMPLE_EVENTS[0])}
            >
          ...
          <div>
            ...
            <select 
              ...
              onChange={(e) => setSelectedParticipant(SAMPLE_PARTICIPANTS.find(p => p.id === e.target.value) || SAMPLE_PARTICIPANTS[0])}
            >
