                ...
                <div className="flex h-16 items-center justify-between">
                    <div className="flex items-center gap-8">
                        <Link className="flex items-center gap-2 text-foreground" to="/">
                            <h1 className="text-xl font-bold">PMI Côte d'Ivoire Events</h1>
                        </Link>
                        <nav className="hidden md:flex items-center gap-6">
                            ...
                            <Link className="text-sm font-medium text-muted-foreground hover:text-event-primary transition-colors" to="/">Mes événements</Link>
                        </nav>
                    </div>
